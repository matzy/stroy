...
public class NWayDiffPaneMessages extends JPanel implements NWayDiffPane {
    ...
    public NWayDiffPaneMessages( final List<TreeMatchingTask<FileContent>> tasks,
    ...
    private List<DiffTree> createTrees(List<TreeMatchingTask<FileContent>> tasks, List<DefaultMutableTreeNode> roots, ShowChangeTreeCellRenderer showChangeTreeCellRenderer) {
