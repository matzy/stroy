...
public class XMLtoReadableTest {
    ...
    public void testOneString() {
        ...
        assertTrue(map.containsKey(Key.valueOf("key")));
        assertEquals( "txt", map.get(Key.valueOf("key")).toString());
    }
    ...
    public void testOneMap() {
        ...
        assertTrue(map.containsKey( Key.valueOf( "things")));
        Readable rr = map.get(Key.valueOf( "things"));
        assertTrue( rr instanceof RMap );

        RMap things = (RMap)rr;

        assertEquals("txt", things.get(Key.valueOf("one")).toString());
        assertEquals("2", things.get(Key.valueOf("two")).toString());
    }
    ...
    public void testEmptyList() {
        ...
        assertTrue(map.containsKey( Key.valueOf( "foo")));
        Readable rr = map.get(Key.valueOf( "foo"));
    ...
    public void testList() {
        ...
        assertTrue(map.containsKey( Key.valueOf( "list")));
        RList list = (RList)map.get(Key.valueOf( "list"));
    ...
    public void testMore() {
        ...
        assertTrue(map.containsKey( Key.valueOf( "one")));
        Readable rr = map.get(Key.valueOf( "one"));
        assertTrue( rr instanceof RMap );

        assertTrue(map.containsKey( Key.valueOf( "two")));
        rr = map.get(Key.valueOf( "two"));
        assertTrue( rr instanceof RList );

        assertTrue(map.containsKey( Key.valueOf( "three")));
        rr = map.get(Key.valueOf( "three"));
        assertTrue( rr instanceof RString);
    ...
    public void testComplex() {
        ...
        RMap fileTypes = (RMap)map.get(Key.valueOf( "fileTypes"));
        RMap jpeg      = (RMap)fileTypes.get(Key.valueOf("jpg"));

        assertEquals( "lossy picture codec", jpeg.get(Key.valueOf("description")).toString() );
    }
    ...
    public void testSpecialChars() {
        ...
        RMap jpg = (RMap)map.get(Key.valueOf("jpg"));

        assertEquals( "<standard>", jpg.get(Key.valueOf("open")).toString() );
    }
}
