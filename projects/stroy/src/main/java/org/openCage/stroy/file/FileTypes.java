...
//        get().put( ext, new Action( "unknown type",SimilarityAlgorithm.none, ExternalProgs.unknown, ExternalProgs.unknown ));
//        setDirty();
//        return get().get( ext );
//    }
//
...
//        return getOrCreateAction( fileName ).getAlgo();
//    }
//
//
//
...
//            map.put(exts[idx], new Action( exts[idx + 1], algo, diff, open));
//        }
//    }
//
...
//        return getOrCreateActionForExt(s).getDescription();
//    }
//
