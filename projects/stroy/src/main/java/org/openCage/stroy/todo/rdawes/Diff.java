 ...
 * 
 */
package org.openCage.stroy.todo.rdawes;
...
public class Diff {
	...
	private static CharSequence[] split(CharSequence orig, char boundary) {
	...
	public static List<Edit> getEdits(CharSequence src, CharSequence dst, char boundary) {
		...
		return convertArrayToOriginal(edits, srcArray, dstArray);
	}
	
	private static List<Edit> convertArrayToOriginal(List<ArrayEdit> arrayEdits, CharSequence[] src, CharSequence[] dst) {
		List<Edit> edits = new LinkedList<Edit>();
