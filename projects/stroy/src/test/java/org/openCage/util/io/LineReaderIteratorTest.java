...
//                } );
//
//        FileUtils.withIterator( new File( url.getPath()), new VF1<Iterable<String>>() { public void call( Iterable<String> iterable ) {
...
//
//
//        FileUtils.withOpen( new File( url.getPath()), new VF2<String, LoopState>() {
//            public void call( String s, LoopState loopState ) {
