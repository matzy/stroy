...
import org.openCage.stroy.dir.doubles2.CompareDirsImpl2;
import org.openCage.stroy.filter.Ignore;
import org.openCage.stroy.filter.IgnoreByLists;
import org.openCage.stroy.fuzzyHash.CountChangeMetric;
import org.openCage.stroy.fuzzyHash.FuzzyHashGenerator;
import org.openCage.stroy.fuzzyHash.SizeWeightedMetric;
...
//        binder.bind( CountChangeMetric.class ).to( CountChangeMetricAddIgnorant.class );
        ...
        binder.bindConstant().annotatedWith( ForMinor.class ).to(8);
        binder.bindConstant().annotatedWith( ForBuildNumber.class ).to(190);
