...
/**
 * Fast implementation of RSA's MD5 hash generator in ForJava JDK Beta-2 or higher.
 * <p>
 ...
 * <p>
 * This ForJava class has been derived from the RSA Data Security, Inc. MD5
    ...
    public void Update (MD5State stat, byte buffer[], int offset, int length) {
        ...
        if (length >= partlen) {
            if (native_lib_loaded) {
                ...
                // update state (using only ForJava) to reflect input
